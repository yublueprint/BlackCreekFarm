...
class EquipmentSearchForm(forms.Form):
    ...
    hours_used_mode = forms.ChoiceField(
        choices=[("all", "Any Hours Used"), ("range", "Specific Range")],
        required=False,
    ...
    purchase_cost_mode = forms.ChoiceField(
        choices=[("all", "Any Purchase Cost"), ("range", "Specific Range")],
        required=False,
    ...
    service_interval_days_mode = forms.ChoiceField(
        choices=[("all", "Any Service Interval Days"), ("range", "Specific Range")],
        required=False,
