...
UNIT_INPUT_MAX_LENGTH = (
    18  # Do not have it set to more than 18 as BigInt max limit is 18 digits.
)
...
class Livestock(models.Model):
    ...
    purchase_price = models.FloatField(
        default=0, blank=True, null=True, max_length=UNIT_INPUT_MAX_LENGTH
    )
...
class Crop(models.Model):
    ...
    yield_efficiency = models.FloatField(
        default=0, blank=True, null=True, max_length=UNIT_INPUT_MAX_LENGTH
    )
...
class Equipment(models.Model):
    ...
    active = models.CharField(
        default=activeChoices.YES,
        choices=activeChoices,
        blank=True,
        null=True,
        max_length=UNIT_INPUT_MAX_LENGTH,
    )
    last_service_by = models.CharField(
        default=DEFAULT_FILLER_TEXT,
        blank=True,
        null=True,
        max_length=DEFAULT_TEXT_MAX_LENGTH,
    ...
    maintenance_history = models.TextField(
        blank=True, null=True, max_length=DEFAULT_TEXT_MAX_LENGTH
    )
    notes = models.TextField(
        default="", blank=True, null=True, max_length=DEFAULT_TEXT_MAX_LENGTH
    )
...
class Supplies(models.Model):
    ...
    minimum_required = models.FloatField(
        blank=True, null=True, max_length=UNIT_INPUT_MAX_LENGTH
    )
