...
def nameChangeExample(old_name, new_name, id_to_give):
    ...
    test_str = f"User tester edited supply: {old_name}{name_change_msg} (ID: {id_to_give})."
    return test_str
...
class TestEditStockNameChangeFunction:
    ...
    def test_name_changed_true(self):
        ...
        assert nameChangeExample(old_name, new_name, id_to_give) == f"User tester edited supply: Cardboard to Box (ID: {id_to_give})."
    ...
    def test_name_changed_false(self):
        ...
        assert nameChangeExample(old_name, new_name, id_to_give) == f"User tester edited supply: Cardboard (ID: {id_to_give})."