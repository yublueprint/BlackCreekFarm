...
class TestDeleteEquipment:
    ...
    def test_delete_equipment_sucess(self, logged_in_client, valid_minimal_equipment, mock_logger):
        ...
        mock_logger.assert_called_once_with(f"User {user} deleted equipment: {name_gotten} (ID: {id_gotten}).")
    ...
    def test_delete_equipment_not_found(self, logged_in_client, mock_logger):
        ...
        f"Unexpected error during equipment deletion" in mock_logger.call_args[0][0]