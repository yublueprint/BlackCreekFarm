...
class TestDeleteCrop:
    ...
    def test_delete_crop_sucess(self, logged_in_client, valid_minimal_crop, mock_logger):
        ...
        mock_logger.assert_called_once_with(f"User {user} deleted crop: {name_gotten} (ID: {id_gotten}).")
    ...
    def test_delete_crop_not_found(self, logged_in_client, mock_logger):
        ...
        f"Unexpected error during crop deletion" in mock_logger.call_args[0][0]