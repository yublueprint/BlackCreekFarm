...
from .backend.views.crop.crop import add_crop, crop_list, delete_crop, edit_crop
from .backend.views.dashboard.dashboard import dashboard
from .backend.views.equipment.equipment import (add_equipment, delete_equipment,
                                          edit_equipment, equipment_list)
from .backend.views.error_page.error_page import error_page
from .backend.views.livestock.livestock import (add_livestock, delete_livestock,
...
from .backend.views.stock_backups.stock_backups import download_backup, stock_backups
from .backend.views.qr_scanner.qr_scanner import qr_scanner_page, qr_scanner_camera, manually_find_item
